...
class UnPaidHistoryDetailController extends GetxController {
  var matchKey = "";
  ...
  void onInit() {
    ...
    if (args != null && args is UnPaidHistoryDetailArgument) {
      matchKey = args.key;
    }
...
class UnPaidHistoryDetailArgument {
  final String key;
  UnPaidHistoryDetailArgument({required this.key});
}
