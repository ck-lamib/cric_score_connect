                  ...
                  child: Form(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        Obx(
                          () {
                            var strikerDropddownItemList = c
                                    .availableBattingTeam.isEmpty
                                ? (c.battingTeam
                        ...
                        Obx(
                          () {
                            var nonStrikerDropdownItemList = c
                                    .availableBattingTeam.isEmpty
                                ? (c.battingTeam
                                    .map((element) => DropdownMenuItem(
                                        value: element.username,
                            ...
                            if (c.openingStriker.value != null &&
                                nonStrikerDropdownItemList.any((item) =>
                                    item.value ==
                                    c.openingStriker.value?.username)) {
                              nonStrikerDropdownItemList.removeWhere(
                                  (element) =>
                                      element.value ==
                                      c.openingStriker.value?.username);
                            }
                        ...
                        CustomElevatedButton(
                          ...
                          onTap: () {
                            if (c.openingStriker.value == null) {
                              CustomSnackBar.info(
                                  message: "Please select opening striker");
                            } else if (c.openingNonStriker.value == null) {
                              CustomSnackBar.info(
                                  message: "Please select opening non striker");
                            } else if (c.openingBowler.value == null) {
                              CustomSnackBar.info(
                                  message: "Please select opening bowler");
                            } else {
